...
# Gegenstände – Übersicht

## Galerie

```dataviewjs
const pages = dv.pages('#gegenstand')
  .where(p => p.file.folder === "Roman_Split/gegenstaende" && p.doc_type !== "index")
...
for (const p of pages) {
  ...
  const imgHtml = imgVaultPath
    ...
    : `<div style="width:100%;aspect-ratio:1/1;background:#2a2a2a;border-radius:8px;
